    ...
    <nav className="border-b border-gray-200 bg-white">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {/* Dropdown */}
          {open && (
            <div className="absolute right-0 mt-2 w-72 origin-top-right rounded-xl border border-gray-100 bg-white shadow-lg ring-1 ring-black/5 z-50">
              {/* Header */}
              <div className="flex flex-col items-center gap-2 px-5 py-5 border-b border-gray-100">
                {/* Avatar (larger, clickable to change photo) */}
